...
public class EmployeeController {
     ...
     * 封装的数据
     * Employee
     * {empId='2009'empName='null', gender='null', email='null', dId=null}
     *
     * 问题：
     * 请求体中有数据：
     * 但是Employee对象封装不上
     * update tbl_emp where emp_id = 2009
     *
     * 原因：
     * Tomcat：将请求体重的数据，封装一个map
    ...
    public Msg checkuser(@RequestParam("empName")String empName){
        ...
        if (!b){
            ...
            System.out.println("用户名不存在，可以添加");
            return Msg.success();
        }
    }
...
//    = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = =
     ...
     */
    //@RequestMapping("/emps")
//    public String getEmps(HttpServletRequest httpServletRequest) {
//        httpServletRequest.setAttribute("test", "测试JSP页面是否能接收到数据！");
//        return "test";
//    }
